...
public class RobotContainer {
        ...
        public RobotContainer() {
                ...
                commandFactory = new CommandFactory(algaeSubsystem, intakeSubsystemPivot, climbSubsystem,
                                intakeSubsystem,
                                elevatorSubsystem);
                ...
                // PATHPLANNER INFO:
                // These strings (e.g., "coralShoot") MUST match the "Event Name" used in the
                // PathPlanner GUI
                // for Event Markers or Named Commands in your auto paths.
                ...
                NamedCommands.registerCommand("algaeShoot",
                                new InstantCommand(() -> intakeSubsystem.intakeMotorSpeed(
                                                -Constants.IntakeConstants.kBargeShootSpeed,
                                                Constants.IntakeConstants.kBargeShootSpeed)));

                // Create the autoChooser
                // This automatically fetches all ".auto" files from the
                // deploy/pathplanner/autos directory
                // and creates a selector for the SmartDashboard/ShuffleBoard.
        ...
        private void configureBindings() {
                ...
                driver.rightBumper().whileTrue(
                                drivetrain.applyRequest(() -> drive
                                                .withVelocityX(-driver.getLeftY() * MaxSpeed
                                                                * Constants.DriveConstants.kSlowModeMultiplier) // Drive
                                                                                                                // forward
                                                                                                                // with
                                                                                                                // negative
                                                                                                                // Y
                                                ...
                                                .withRotationalRate(-driver.getRightX() * MaxAngularRate) // Drive
                                                                                                          ...
                                                                                                          // negative X
                                                                                                          // (left)
                                                .withDeadband(MaxSpeed * 0).withRotationalDeadband(MaxAngularRate * 0) // Add
                                                                                                                       // a
                                                                                                                       // 10%
                                                                                                                       // deadband
                                ));
                ...
                operator.povLeft().onTrue(climbSubsystem.ClimbPivot_PickupPosition()); // add servo & onFalse release
                                                                                       // servo?
