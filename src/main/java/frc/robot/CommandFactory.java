...
public class CommandFactory {
     ...
     public Command levelOne() {
          ...
          // NOTE: This command runs forever until interrupted.
          // If used in a PathPlanner "Sequence", it will BLOCK the auto from continuing
          // unless it has a .withTimeout()
          // or is in a "Parallel" group.
     ...
     public Command bargeSetpointTheSequelStop() {
          ...
          return Commands.sequence(
                    new RunCommand(() -> intakeSubsystem.intakeMotorSpeed(IntakeConstants.kBargeHoldSpeed,
                              -IntakeConstants.kBargeHoldSpeed), intakeSubsystem)
                              .withTimeout(CommandConstants.kBargeHoldTimeout),
                    new RunCommand(() -> intakeSubsystem.intakeMotorSpeed(-IntakeConstants.kBargeShootSpeed,
                              IntakeConstants.kBargeShootSpeed), intakeSubsystem)
                              .withTimeout(CommandConstants.kBargeShootTimeout),
                    Commands.parallel(
                              elevatorSubsystem.HumanStation_ElevatorPosition(),
                              intakeSubsystemPivot.HumanStation_IntakePosition(),
                              new RunCommand(() -> intakeSubsystem.intakeMotorSpeed(0, 0), intakeSubsystem)
                                        .withTimeout(CommandConstants.kStopTimeout)) // Stops motors and requires
                                                                                     // subsystem
          );
     }
          ...
          return new edu.wpi.first.wpilibj2.command.StartEndCommand(
                    () -> {
                         if (elevatorSubsystem.isAtPositionSetpoint(ElevatorConstants.kL1Position)) {
                              intakeSubsystem.intakeMotorSpeed(IntakeConstants.kSpinShotLeftSpeed,
                                        IntakeConstants.kSpinShotRightSpeed); // Spin shot
                         } else {
                              intakeSubsystem.intakeMotorSpeed(-IntakeConstants.kShootSpeed,
                                        IntakeConstants.kShootSpeed); // Regular Shot
                         }
                    },
     ...
     public Command coralAutoBranch() {
          ...
          return Commands.sequence(
                    new RunCommand(() -> intakeSubsystem.intakeMotorSpeed(-IntakeConstants.kShootSpeed,
                              IntakeConstants.kShootSpeed), intakeSubsystem)
     ...
     public Command coralAutoTrough() {
          ...
          return Commands.sequence(
                    new RunCommand(() -> intakeSubsystem.intakeMotorSpeed(-IntakeConstants.kShootSpeed,
                              IntakeConstants.kTroughRightSpeed), intakeSubsystem)
                              .withTimeout(CommandConstants.kCoralShootTimeout),
                    new RunCommand(() -> intakeSubsystem.intakeMotorSpeed(0, 0), intakeSubsystem)
                              .withTimeout(CommandConstants.kStopTimeout));
     }
     ...
     public Command coralIntake() {
          ...
          return Commands.sequence(
                    new RunCommand(() -> intakeSubsystem.intakeMotorSpeed(IntakeConstants.kIntakeSpeed,
                              -IntakeConstants.kIntakeSpeed), intakeSubsystem)
